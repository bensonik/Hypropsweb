        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Generate Pin Code</h4>
                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <b>Enter number of pin code to be generated</b>
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="multiple_of" placeholder="Multiple of">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_user_pin_code'); ?>','reload_data',
                            '<?php echo url('user_pin_code'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('user_pin_code'); ?>',
                                    '<?php echo url('delete_user_pin_code'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
