        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    Sales Order Number
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{$edit->sales_number}} " name="sales_number" placeholder="Sales Order Number">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                    ...
                    <div class="form-line">
                        <select class="form-control ship_status" name="sales_status" >
                            ...
                            @foreach(\App\Helpers\Utility::SHIP_STATUS as $key => $val)
                                @if($edit->sales_status == $val)
                                    <option selected value="{{$edit->sales_status}}">{{$val}}</option>
                    ...
                    @if($po->account_id != '')
                        ...
                        <tr id="itemId{{$po->id}}">
                            ...
                            <td class="center-align" id="{{$po->unit_cost_trans}}">
                                <div class="form-group">
                                    <div style="cursor: pointer;" id="" onclick="permItemDelete('itemId{{$po->id}}','<?php echo url('delete_sales_item') ?>','{{$po->id}}','{{$po->extended_amount_trans}}','overall_sum_edit','foreign_overall_sum_edit','<?php echo url('amount_to_default_curr') ?>','tax_amount_acc{{$num}}','discount_amount_acc{{$num}}','total_tax_amount_edit','total_discount_amount_edit','vendorCust_edit','posting_date_edit','{{$po->sales_id}}','<?php echo url('update_sum') ?>','reload_data','{{url('sales_order')}}','sales_extention')">
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-hover table-striped" id="po_main_table_edit">
                ...
                @foreach($salesData as $po)
                    ...
                    @if(!empty($po->item_id))
                        <?php $num++; $num2++; $countDataPo[] = $num2; $shipStatus = ($po->ship_status != '0' && $po->ship_status != '') ? 'checked' : ''; ?>
                        <tr id="itemId{{$po->id}}">

                            <td scope="row">
                                <input value="{{$po->id}}" type="checkbox" id="po_id{{$po->id}}" {{$shipStatus}} class="kid_checkbox_po_edit" />
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class=" " name="item_desc{{$num2}}" id="item_desc{{$num}}" placeholder="Description">{{$po->sales_desc}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class=" " name="quantity_shipped{{$num2}}" value="{{$po->shipped_quantity}}" id="qty_rec{{$num}}" placeholder="Quantity" >
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class=" datepicker4 " value="{{$po->planned_ship_date}}" name="planned_date{{$num2}}" placeholder="Planned Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class=" datepicker4 " value="{{$po->expected_ship_date}}" name="expected_date{{$num2}}" placeholder="Expected Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class=" datepicker4 " value="{{$po->promised_ship_date}}" name="promised_date{{$num2}}" placeholder="Promised Date" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
