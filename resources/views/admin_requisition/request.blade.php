            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        @if($appAccess === 1)
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_admin_requests'); ?>',
                                    '<?php echo url('approve_admin_requisition'); ?>','<?php echo csrf_token(); ?>','1');" class="btn btn-success">
                                <i class="fa fa-check-square-o"></i>Approve
                            </button>
                        </li>
                        <li>
                            <button type="button" onclick="RequestApproval('kid_checkbox','reload_data','<?php echo url('my_admin_requests'); ?>',
                                    '<?php echo url('approve_admin_requisition'); ?>','<?php echo csrf_token(); ?>','0');" class="btn btn-danger">
