                                ...
                                <div class="body">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="welcome">
                                            <b>Welcome</b>
                                            <p>
                                                This is competency framework. Select the tab of your choice to enter the type of
                                                competency framework you desire. Please take note of saving before you close
                                                the window.
                                            </p>
                                        </div>
                                        <div role="tabpanel" class="tab-pane fade" id="comp_{{\App\Helpers\Utility::PRO_QUAL}}">
                                            ...
                                            <button onclick="save1('createModal','createMainForm1','<?php echo url('create_comp_frame'); ?>','reload_data',
                                                    '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>','department_pro','position_pro','min_aca_qual','cog_exp','pro_qual','yr_post_cert')" type="button" class="pull-right btn btn-info waves-effect">
                                                SAVE
                                            </button>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="comp_{{\App\Helpers\Utility::TECH_COMP}}">
                                            ...
                                            <button onclick="save2('createModal','createMainForm2','<?php echo url('create_comp_frame'); ?>','reload_data',
                                                    '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>','department_tech','position_tech','competency_cat_tech','tech_level','cat_desc_tech')" type="button" class="pull-right btn btn-info waves-effect">
                                                SAVE
                                            </button>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="comp_{{\App\Helpers\Utility::BEHAV_COMP}}">
                                            ...
                                            <button onclick="save3('createModal','createMainForm3','<?php echo url('create_comp_frame'); ?>','reload_data',
                                                    '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>','department','position','competency_cat','cat_desc','behav_level')" type="button" class="pull-right btn btn-info waves-effect">
                                                SAVE
                                            </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button onclick="submitMediaForm('editModal','editMainForm','<?php echo url('edit_comp_frame'); ?>','reload_data',
                            '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                        SAVE
                    </button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                </div>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('competency_framework'); ?>',
                                    '<?php echo url('delete_comp_frame'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select  class="form-control" name="position" id="position_search" >
                                            <option value="">Position</option>
                                            @foreach($position as $ap)
                                                <option value="{{$ap->id}}">{{$ap->position_name}}</option>
                                            @endforeach
                        ...
                        <button onclick="searchReport('searchFrameForm','<?php echo url('search_frame'); ?>','reload_data',
                                '<?php echo url('competency_framework'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-info waves-effect">
                            Search
                        </button>
...
<script>
    ...
    function save2(formModal,formId,submitUrl,reload_id,reloadUrl,token,dept,position,compCat,level,techDesc) {
        ...
        if(arrayItemEmpty(dept1) == false && arrayItemEmpty(position1) == false && arrayItemEmpty(compCat1) == false && arrayItemEmpty(level1) == false){
            ...
            //alert(encodeURIComponent(postVars));
            $('#loading_modal').modal('show');
            $('#' + formModal).modal('hide');
            sendRequestForm(submitUrl, token, postVars)
            ajax.onreadystatechange = function () {
                if (ajax.readyState == 4 && ajax.status == 200) {
                    ...
                    if (message2 == 'fail') {
                        ...
                        swal("Success!", "Data saved successfully!", "success");
                        //location.reload();
                        //hideAddedInputs('new_tech_comp','add_more2','hide_button2','<?php echo URL::to('add_more'); ?>','tech_comp','hide_button2');
...
<script>
    ...
    <script>
        ...
        function getCustom(page){
            ...
            $.ajax({
                url: '<?php echo URL::to('search_frame'); ?>?page='+page+'&competency_type='+compType+'&position='+positionSearch+'&department='+deptSearch
            }).done(function(data){
                $('#reload_data').html(data);
            });
        }
