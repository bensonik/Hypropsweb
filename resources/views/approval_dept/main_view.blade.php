        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Departmental Approval</h4>
                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" class="user_class" name="dept_head" id="user" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control" name="approval_system" >
                                                <option value="" selected>Approval System</option>
                                                @foreach($approval as $dat)
                                                    <option value="{{$dat->id}}">{{$dat->approval_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_dept_approval'); ?>','reload_data',
                            '<?php echo url('dept_approval'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_dept_approval'); ?>','reload_data',
                            '<?php echo url('dept_approval'); ?>','<?php echo csrf_token(); ?>')"
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('dept_approval'); ?>',
                                    '<?php echo url('delete_dept_approval'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body table-responsive" id="reload_data">
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>{{$data->approval->approval_name}}</td>
                            <td>
                            ...
                            <td>
                                <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_dept_approval_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
