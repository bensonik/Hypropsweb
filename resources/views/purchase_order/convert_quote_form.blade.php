        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" value="" autocomplete="off" id="select_vendor_edit" onkeyup="searchOptionListVenCust('select_vendor_edit','myUL1_edit','{{url('default_select')}}','search_vendor_transact','vendorCust_edit','foreign_amount_edit','<?php echo url('vendor_customer_currency') ?>','overall_sum_edit','{{\App\Helpers\Utility::VENDOR}}','vendorCust_edit','posting_date_edit','billing_address_edit','curr_rate_edit','foreign_overall_sum_edit');" name="select_user" placeholder="Select Vendor">
