        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Lesson Learnt</h4>
                </div>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class="form-control" name="situation" placeholder="Situation"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea type="text" class="form-control" name="need" placeholder="Need"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea type="text" class="form-control" name="follow_up" placeholder="Folllow Up"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_lesson_learnt'); ?>','reload_data',
                            '<?php echo url('project/'.$item->id.'/lesson_learnt'.\App\Helpers\Utility::authLink('temp_user')); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_lesson_learnt'); ?>','reload_data',
                            '<?php echo url('project/'.$item->id.'/lesson_learnt'.\App\Helpers\Utility::authLink('temp_user')); ?>','<?php echo csrf_token(); ?>')"
                                    ...
                                    <div class="card">
                                        <div class="header">
                                            ...
                                            <ul class="header-dropdown m-r--5">
                                                ...
                                                <li>
                                                    <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('project/'.$item->id.'/lesson_learnt'.\App\Helpers\Utility::authLink('temp_user')); ?>',
                                                            '<?php echo url('delete_lesson_learnt'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                                        ...
                                        <div class="body table-responsive" id="reload_data">
                                            <table class="table table-bordered table-hover table-striped" id="main_table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_lesson_learnt_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                    </td>
