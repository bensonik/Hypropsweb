                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card">
                                        <div class="header">
                                            <h2>
                                                Selected {{$mainData->type}} and Comments
                                            </h2>
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <div class="form-line">
                                                                                <textarea type="text" class="form-control" name="comment" placeholder="Comment on {{$mainData->type}}"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        <input type="hidden" name="assump_id" value="{{$mainData->id}}" />
                                                                        <input type="hidden" name="project" value="{{$item->id}}" />
                                                                    </form>
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                                <button type="button" class="form-control pull-right btn-info"
                                                                                        onclick="submitComment('commentModal','commentMainForm','<?php echo url('comment_assump_constraint'); ?>','display_comment',
