        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Survey</h4>
                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="survey_name" placeholder="Survey Name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class="form-control" name="survey_details" placeholder="Survey Details"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_survey'); ?>','reload_data',
                            '<?php echo url('survey'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_survey'); ?>','reload_data',
                            '<?php echo url('survey'); ?>','<?php echo csrf_token(); ?>')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <ul class="header-dropdown m-r--5 " style="list-style-type: none;">
                    <li class="pull-right">
                            <button type="button" onclick="removeAddItem('kid_checkbox_add','reload_data','<?php echo url('survey'); ?>',
                                    '<?php echo url('modify_survey_dept'); ?>','<?php echo csrf_token(); ?>','1','add selected Item(s)','survey_id','editDeptModal');" class="btn btn-success">
                                <i class="fa fa-plus"></i>Add
                            </button>
                    </li>
                    <li>
                        <button type="button" onclick="removeAddItem('kid_checkbox_remove','reload_data','<?php echo url('survey'); ?>',
                                '<?php echo url('modify_survey_dept'); ?>','<?php echo csrf_token(); ?>','0','remove selected Item(s)','survey_id','editDeptModal');" class="btn btn-danger">
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('survey'); ?>',
                                    '<?php echo url('delete_survey'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
