        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        General Category
                                        <div class="form-line">
                                            <input type="checkbox" class="" value="1" name="general" />
                                        </div>
                                    </div>
                                </div>
                                @else
                                 <input type="hidden" value="0" name="general" />
                                @endif
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_request_cat'); ?>','reload_data',
                            '<?php echo url('request_category'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_request_cat'); ?>','reload_data',
                            '<?php echo url('request_category'); ?>','<?php echo csrf_token(); ?>')"
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('request_category'); ?>',
                                    '<?php echo url('delete_request_cat'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                ...
                <div class="body table-responsive" id="reload_data">
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        <tr>
                            ...
                            <td>{{$data->account_cat->category_name}}</td>
                            <td>
                                @if($data->dept_id != 0 || $data->dept_id != '')
