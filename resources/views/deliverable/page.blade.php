        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Deliverable</h4>
                </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea type="text" class="form-control" name="deliverable" placeholder="Deliverable"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_deliverable'); ?>','reload_data',
                            '<?php echo url('project/'.$item->id.'/deliverable'.\App\Helpers\Utility::authLink('temp_user')); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_deliverable'); ?>','reload_data',
                                    ...
                                    <div class="card">
                                        <div class="header">
                                            ...
                                            <ul class="header-dropdown m-r--5">
                                                ...
                                                <li>
                                                    <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('project/'.$item->id.'/deliverable'.\App\Helpers\Utility::authLink('temp_user')); ?>',
                                                            '<?php echo url('delete_deliverable'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
