        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Physical Inventory Count</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_physical_inv_count'); ?>','reload_data',
                            '<?php echo url('physical_inv_count'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_physical_inv_count'); ?>','reload_data',
                            '<?php echo url('physical_inv_count'); ?>','<?php echo csrf_token(); ?>')"
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Physical Inventory Count Types
                    </h2>
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('physical_inv_count'); ?>',
                                    '<?php echo url('delete_physical_inv_count'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
