        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-indigo hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->ongoingOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-green hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->wonOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-red hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->lostOpport)}}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-deep-orange hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->overdueOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-pink hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->opportClosingToday)}}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-red hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{\App\Helpers\Utility::defaultCurrency()}}{{number_format($chartObject->ongoingOpportAmount)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-green hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{\App\Helpers\Utility::defaultCurrency()}}{{number_format($chartObject->wonOpportAmount)}}</div>
                </div>
            </div>
        </div>
