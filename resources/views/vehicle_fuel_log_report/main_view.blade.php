                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick" multiple name="fuel_station[]" data-selected-text-format="count">
                                                <option value="0" selected>Select All Fuel Station</option>
                                                @foreach($fuelStation as $ap)
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info col-sm-8" type="button" onclick="searchReportRequest('searchMainForm','<?php echo url('search_vehicle_fuel_log_report'); ?>','reload_data',
                                                '<?php echo url('vehicle_fuel_log_report'); ?>','<?php echo csrf_token(); ?>','start_date','end_date')">Search</button>
                                    </div>
                                </div>
