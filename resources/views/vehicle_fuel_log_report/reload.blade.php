        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-deep-orange hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->totalPurchasePrice)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-green hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($chartObject->totalLiters)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <table class="table table-bordered table-hover table-striped" id="">
                        ...
                        @foreach($mainData as $data)
                            <tr>
                                ...
                                <td>{{number_format($data->price_per_liter)}}</td>
