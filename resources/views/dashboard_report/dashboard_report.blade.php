        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-indigo hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($crmReport->ongoingOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-green hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($crmReport->wonOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-red hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($crmReport->lostOpport)}}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-deep-orange hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($crmReport->overdueOpport)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-pink hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($crmReport->opportClosingToday)}}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-deep-orange hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($vehicleServiceLogReport->totalBill)}}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-red hover-zoom-effect">
                ...
                <div class="content">
                    <div class="text">{{$month}} Total Mileage Spent in Workshop(s)</div>
                    <div class="number">{{number_format($vehicleServiceLogReport->workshopMileage)}}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-deep-orange hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($vehicleFuelLogReport->totalPurchasePrice)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-green hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{number_format($vehicleFuelLogReport->totalLiters)}}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="info-box-3 bg-red hover-zoom-effect">
                ...
                <div class="content">
                    <div class="text">{{$month}} Total Vehicle Mileage Accrued With Purchased Fuel</div>
                    <div class="number">{{number_format($vehicleFuelLogReport->totalMileage)}}</div>
                </div>
            </div>
        </div>
