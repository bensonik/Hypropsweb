        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Bin</h4>
                </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea class="form-control" name="bin_description" placeholder="Bin Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_bin'); ?>','reload_data',
                            '<?php echo url('bin'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('bin'); ?>',
                                    '<?php echo url('delete_bin'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
