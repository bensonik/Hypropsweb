            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitMediaFormRequest('attachModal','attachForm','<?php echo url('hse_report_response'); ?>','reload_data',
                            '<?php echo url('all_hse_report'); ?>','<?php echo csrf_token(); ?>','hse_response','search_hse_button')"
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick" id="" name="source_type" data-selected-text-format="count">
                            ...
                            <div class="row clear-fix">
                                ...
                                <div class="col-sm-9" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info col-sm-8" type="button" onclick="searchReportRequest('searchMainForm','<?php echo url('search_hse_report'); ?>','reload_data',
                                                '<?php echo url('hse_report'); ?>','<?php echo csrf_token(); ?>','start_date','end_date')" id="search_hse_button">Search</button>
                                    </div>
                                </div>
