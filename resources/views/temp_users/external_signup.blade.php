...
<head>
    ...
    <title>Sign Up | External Account</title>
    <!-- Favicon-->
    ...
    <div class="card">
        <div class="body">
            ...
            <div class="msg">Create an account</div>
                ...
                <input type="hidden" name="role" value="{{\App\Helpers\Utility::TEMP_EXTERNAL_STAFF}}" />
                <input type="hidden" name="external_type" value="non_client" />
