...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Budget/Requisition Comparison Report (Chart Representation)
                </h2>
                ...
                <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="body">
                        ...
                        <div class="row clear-fix">
                            ...
                            <div class="col-sm-4" id="" style="">
                                <div class="form-group">
                                    <button class="btn btn-info" type="button" onclick="searchReportRequest('searchMainForm','<?php echo url('search_budget_request_compare'); ?>','reload_data',
                                        '<?php echo url('budget_request_compare'); ?>','<?php echo csrf_token(); ?>','from_date','to_date','budget')">Search</button>
                                </div>
                            </div>
...
<script>
    ...
    function searchReportRequest(formId,submitUrl,reload_id,reloadUrl,token,fromId,toId,budgetId){
        ...
        if(from != '' && to !='' && idVal(budgetId) != ''){
            ...
            swal("warning!", "Please ensure to select start and end date, budget.", "warning");
