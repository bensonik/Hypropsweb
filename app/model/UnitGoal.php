...
class UnitGoal extends Model
{
    ...
    public function u_goal_cat(){
        return $this->belongsTo('App\model\UnitGoalCat','unit_goal_cat','id');

    }

    public function unit_goal_ext(){
        return $this->hasMany('App\model\UnitGoalExt','unit_goal_id','id');
    ...
    public static function countData3($column, $post, $column2, $post2, $column3, $post3)
    {
        ...
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
            ->where($column2, '=',$post2)->where($column3, '=',$post3)->count();
    ...
    public static function specialColumnsObj2($column, $post, $column2, $post2)
    {
        return static::where('status', '=',Utility::STATUS_ACTIVE)->where($column, '=',$post)
            ->where($column2, '=',$post2)->paginate(Utility::P35);
    ...
    {
        return Utility::firstRow2(self::table(),$column, $post,$column2, $post2, $column3, $post3);
