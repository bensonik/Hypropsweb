...
class QuoteController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $user = $request->input('user'); $grandTotal = $request->input('grand_total');
            $grandTotalVendorCurr = $request->input('grand_total_vendor_curr');
    ...
    public function edit(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $mailOption = $request->input('mail_option'); $emails = $request->input('emails'); $file = $request->input('file');
            $message = $request->input('mail_message'); $oneTimeDiscount = $request->input('one_time_discount_amount_edit');
