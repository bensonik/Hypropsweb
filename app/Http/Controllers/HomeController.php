...
class HomeController extends Controller
{
    ...
    public function lastRequisitionReport()
    {
        ...
        $mainData = (in_array(Auth::user()->role,Utility::TOP_USERS)) ? Requisition::customDataPaginate('5') : Requisition::customDataPaginate2('user_id',Auth::user()->id,'5');
    ...
    public function lastLeaveRequests()
    {
        ...
        $mainData = (in_array(Auth::user()->role,Utility::TOP_USERS)) ? LeaveLog::customDataPaginate('5') : LeaveLog::customDataPaginate2('user_id',Auth::user()->id,'5');
